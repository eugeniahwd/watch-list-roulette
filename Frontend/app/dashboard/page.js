  ...
  return (
    <main style={{ minHeight: "100vh", background: "#09090b", fontFamily: "sans-serif" }}>
      ...
      <div style={{ paddingTop: "32px", paddingBottom: "60px" }}>
        <Section title="Recommendations For You" movies={sections.recommendations} />
        <Section title="Popular Right Now" movies={sections.popular} />
        <Section title="Romance & Comedy" movies={sections.romanceComedy} />
        <Section title="Action & Thriller" movies={sections.actionThriller} />
        <Section title="K-Drama" movies={sections.kdrama} />
      </div>
